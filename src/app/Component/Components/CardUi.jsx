...
const CardUi = () => {
  return (
          ...
          <div className='flex flex-col items-center gap-3 md:w-[25rem] max-md:w-[20rem] max-sm:w-[90%] rounded-2xl px-3 py-3 text-white border duration-200 border-[#3c434b] bg-[#1C2025] hover:shadow-md hover:shadow-[#827c8b] cursor-pointer'>
